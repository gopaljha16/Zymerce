...
sample_products = [
    ...
    },
    {
        ...
        'category': Category.objects.get(name='Books & Stationery'),
        'stock': 120,
    ...
    },
    {
        ...
        'category': Category.objects.get(name='Sports & Outdoors'),
        'stock': 45,
    ...
    },
    {
        ...
        'category': Category.objects.get(name='Health & Wellness'),
        'stock': 90,
    ...
    },
    {
        ...
        'price': Decimal('1299.00'),
        'category': Category.objects.get(name='Toys & Games'),
        'stock': 60,
